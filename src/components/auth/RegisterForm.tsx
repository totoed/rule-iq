...
const RegisterForm = ({
  ...
  const { signUp, setIsAnonymous, signInWithProvider } = useAuth();
  ...
  const sendWelcomeEmail = async (email: string, name: string) => {
    try {
      // This would typically call a Supabase Edge Function or other email service
      // For now, we'll just log it since we don't have the actual implementation
